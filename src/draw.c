 ...
 * addendum to Glyph.
 *
 * UPDATE - I took this straight from the Cards project - I'm going to throw
 * this into the TSP project, recklessly, to see what needs to be changed to
 * make it generic enough to use in the toolbox (looks like it already is?)
 *
 *****/
